...
cookies = {
    ...
    '_ym_isad': '2',
    '_ym_visorc': 'b',
    'qrator_jsid': '1687271154.470.EW5vphBa1eEDM4Vc-ldassv1j90b9gf65te3r7jjivjef6dag',
    'rr-testCookie': 'testvalue',
    '_gat': '1',
    '_gat_%5Bobject%20Object%5D': '1',
    '_ga_FLS4JETDHW': 'GS1.1.1687271156.5.1.1687273077.59.0.0',
    '_ga': 'GA1.1.487180927.1687152784',
    'tmr_detect': '0%7C1687273079597',
}
...
async def get_page_data(session, page):
    ...
    async with session.get(url=url, headers=headers, cookies=cookies,) as response:
        ...
        for _ in range(0, len(laptops)):
            ...
            matrix = (laptops[_].find_all("span")[1].text.split()[5],laptops[_].find_all("span")[1].text.split()[6])
